"""
Django settings for CFD_EE project.
...
WSGI_APPLICATION = 'CFD_EE.wsgi.application'
...
DATABASES = {
    'default': {#Modified for heroku deployment reverted
...
#Modified for heroku deployment reverted
